...
| [operations/deployment.md](./operations/deployment.md) | GCP infrastructure architecture |

## Other authoritative references

- [`/README.md`](../README.md) — project overview and quick start
- [`/CLAUDE.md`](../CLAUDE.md) — repo-level orientation (role model, env vars, troubleshooting)
- [`/deploy/README.md`](../deploy/README.md) — operational runbook (SSH deploy, rollback, systemd)
- [`/apps/api/database/README.md`](../apps/api/database/README.md) — schema, migrations, local bootstrap
